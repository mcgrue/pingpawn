...
Configure::write('SparkPlug.hash.method', 'sha1');	// use sha1 to be compatible with passwords generated by Cake's Auth Component
Configure::write('SparkPlug.hash.salt', true);		// use true to be compatible with passwords generated by Cake's Auth Component
